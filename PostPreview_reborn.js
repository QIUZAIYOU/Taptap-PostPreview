...
(function () {
    ...
    const modules = {
        ...
        async insertPreviewButtonToMomentCard() {
            ...
            <span class="previewButton icon-button flex-center--y moment-card_repost--btn moment-card__footer-btn" data-booth-item="" data-track-prevent="click" data-booth-level="1">
            ...
            await elmGetter.each(selecter.momentCardFooter, (momentCardFooter) => {
                if (document.querySelector(selecter.momentCardFooter).querySelector(selecter.previewButton)) document.querySelector(selecter.momentCardFooter).querySelector(selecter.previewButton).remove()
